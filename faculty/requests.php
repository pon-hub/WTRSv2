...
$reqStmt = $pdo->prepare("
    SELECT ar.id, ar.created_at, u.first_name, u.last_name, u.student_id, u.course, u.year_level
            ...
            <?php foreach ($requests as $req): ?>
                <div class="req-card">
                    <div class="req-info">
                        ...
                        <div class="req-meta">
                            ID: <?= htmlspecialchars($req['student_id'] ?: 'N/A') ?> &bull; 
                            <?= htmlspecialchars($req['course'] ?: 'Course N/A') ?> &bull; 
                            <?= htmlspecialchars($req['year_level'] ?: 'Year N/A') ?>
                        </div>
